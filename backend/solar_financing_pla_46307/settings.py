"""
Django settings for solar_financing_pla_46307 project.
...
ROOT_URLCONF = 'solar_financing_pla_46307.urls'
...
WSGI_APPLICATION = 'solar_financing_pla_46307.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "solar_financing_pla_46307 API",
    "DESCRIPTION": "API documentation for solar_financing_pla_46307 App",
    "VERSION": "v1",
}
